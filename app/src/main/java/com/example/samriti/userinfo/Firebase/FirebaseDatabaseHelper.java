package com.example.samriti.userinfo.Firebase;
...
import com.example.samriti.userinfo.Adapters.RecyclerViewAdapter;
...
public class FirebaseDatabaseHelper {
    ...
    public void createUserInFirebaseDatabase(String userId, FirebaseUserEntity firebaseUserEntity){
        ...
        databaseReference.child("users").child(userId).setValue(firebaseUserEntity);
    }
    ...
    private List<UserProfile> adapterSourceData(DataSnapshot dataSnapshot, String uId){
        ...
        if(dataSnapshot.getKey().equals(uId)){
            ...
            allUserData.add(new UserProfile(Helper.BLOOD_GROUP, userInformation.getblood()));
        }
        return allUserData;
    }
}
